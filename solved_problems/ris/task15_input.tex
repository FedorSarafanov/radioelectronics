...
% \pgfplotstableread{data.tsv}\mytable
	...
	\begin{tikzpicture}
		...
		\addplot[domain={-2:2},samples=700] {(x<-1?0:1)-(x<0?0:1)+(x<1?0:1)-(x<0?0:1)} node[pos=.4, right, yshift=0.5em]{A} node[pos=0.1, below, yshift=0.1em]{$-\tau$} node[pos=0.9, below]{$\tau$}; 
